    ...
    var t,
      ...
      v = function () {
        var t = e(this),
          ...
          u =
            "yx" === i.axis
              ? "<div id='mCSB_" + n.idx + "_container_wrapper' class='mCSB_container_wrapper' />"
              : "",
      ...
      w = function () {
        ...
        n.scrollButtons.enable &&
          i.prepend(s[0]).append(s[1]).next(".mCSB_scrollTools").prepend(s[2]).append(s[3]);
      },
      S = function () {
        var t = e(this),
          o = t.data(a),
      ...
      I = function () {
        ...
        m
          ...
          .bind(
            "mousedown." + u + " touchstart." + u + " pointerdown." + u + " MSPointerDown." + u,
            function (t) {
          ...
          if ((Q(o), !z(o, t.target))) {
            ...
            if ("x" === i.axis || "x" === i.mouseWheel.axis)
              ...
              var u = "y",
                ...
                h =
                  "auto" !== i.mouseWheel.scrollAmount ? f[1] : f[0] >= l.height() ? 0.9 * l.height() : f[0],
      ...
      P = function () {
        ...
        s.bind(
          "mousedown." + i + " touchstart." + i + " pointerdown." + i + " MSPointerDown." + i,
          function (o) {
      ...
      J = function (e, t, o, a, n, i, r) {
        ...
        function s() {
          a > 0
            ? ((S.currVal = u(S.time, _, b, a, n)), (w[t] = Math.round(S.currVal) + "px"))
            : (w[t] = o + "px"),
            p.call();
        }
        function c() {
        ...
        function d() {
          null != S.id &&
            (window.requestAnimationFrame ? window.cancelAnimationFrame(S.id) : clearTimeout(S.id),
            (S.id = null));
        }
        function u(e, t, o, a, n) {
          switch (n) {
            ...
            case "mcsEaseInOut":
              return (
                (e /= a / 2), 1 > e ? (o / 2) * e * e * e + t : ((e -= 2), (o / 2) * (e * e * e + 2) + t)
              );
            case "easeOutSmooth":
